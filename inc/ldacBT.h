 ...
 *  Arguments
 *      @param    HANDLE_LDAC_BT    LDAC handle.
 *      @param    p_bs       unsigned char *   Pointer to "ldac_transport_frame".
 *      @param    p_pcm      unsigned char *   Decoded out PCM signal sequence.
 *      @param    fmt        LDACBT_SMPL_FMT_T Audio format type of output pcm.
 *      @param    bs_bytes    int *            Data size of input "ldac_transport_frame". Unit: Byte.
 *      @param    used_bytes  int *            Data size of referenced "ldac_transport_frame". Unit: Byte.
 *      @param    wrote_bytes int *            Size of decoded out PCM signal. Unit: Byte.
 *  Return value
 *      int : 0 for success, -1 for failure.
 */
