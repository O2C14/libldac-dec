...
***************************************************************************************************/
static int encode_band_info_ldac(__attribute__((unused)) AB* p_ab) {
  int nbits;
...
***************************************************************************************************/
static int encode_gradient_ldac(AB* p_ab) {
  int nbits;
...
***************************************************************************************************/
__inline static int get_minimum_id_ldac(int* p_nbits, int n) {
  int i;
  int id, nbits;
...
static int encode_scale_factor_0_ldac(AC* p_ac, SFCINF* p_sfcinf) {
  HCENC* p_hcsf;
  int iqu, iwt;
...
static int encode_scale_factor_1_ldac(AC* p_ac, SFCINF* p_sfcinf) {
  int iqu, iwt;
  int nqus = p_ac->p_ab->nqus;
  int nbits = LDAC_MAXBITNUM;
...
static int encode_scale_factor_2_ldac(AC* p_ac, SFCINF* p_sfcinf) {
  HCENC* p_hcsf;
  int iqu;
  int nqus = p_ac->p_ab->nqus;
...
***************************************************************************************************/
static int encode_scale_factor_ldac(AC* p_ac) {
...
***************************************************************************************************/
DECLFUNC int encode_side_info_ldac(AB* p_ab) {
  AC* p_ac;
  int ich;
...
***************************************************************************************************/
DECLFUNC void calc_add_word_length_ldac(AC* p_ac) {
  int iqu;
  int nqus = p_ac->p_ab->nqus;
  int dif;
  int* p_idsf = p_ac->a_idsf;
