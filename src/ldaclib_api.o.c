...
***************************************************************************************************/
static int ldaclib_assert_sampling_rate_index(int smplrate_id) {
...
static int ldaclib_assert_supported_sampling_rate_index(int smplrate_id) {
...
static int ldaclib_assert_nlnn_shift(int nlnn_shift) {
...
static int ldaclib_assert_sample_format(LDAC_SMPL_FMT_T sample_format) {
...
DECLSPEC LDAC_RESULT ldaclib_set_frame_header(
  ...
  pack_frame_header_ldac(smplrate_id, chconfig_id, frame_length, frame_status, (STREAM*)p_stream);
...
/***************************************************************************************************
    Set Frame Length
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_set_encode_frame_length(HANDLE_LDAC hData, int frame_length) {
  CFG* p_cfg = &hData->sfinfo.cfg;
...
/***************************************************************************************************
    Get Frame Length
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_get_encode_frame_length(HANDLE_LDAC hData, int* p_frame_length) {
  CFG* p_cfg = &hData->sfinfo.cfg;
...
DECLSPEC LDAC_RESULT ldaclib_set_encode_info(
    ...
    int grad_os_h,
    int abc_status) {
  if ((nbands < LDAC_BAND_OFFSET) || (ga_max_nbands_ldac[hData->sfinfo.cfg.smplrate_id] < nbands)) {
...
/***************************************************************************************************
    Initialize
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_init_encode(HANDLE_LDAC hData) {
...
/***************************************************************************************************
    Free
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_free_encode(HANDLE_LDAC hData) {
...
DECLSPEC LDAC_RESULT ldaclib_flush_encode(
    HANDLE_LDAC hData, LDAC_SMPL_FMT_T sample_format, unsigned char* p_stream, int* p_nbytes_used) {
  LDAC_RESULT result;
  int ich;
...
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_clear_error_code(HANDLE_LDAC hData) {
  hData->error_code = LDAC_ERR_NONE;
...
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_get_error_code(HANDLE_LDAC hData, int* p_error_code) {
...
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_clear_internal_error_code(HANDLE_LDAC hData) {
...
***************************************************************************************************/
DECLSPEC LDAC_RESULT ldaclib_get_internal_error_code(HANDLE_LDAC hData, int* p_error_code) {
...
DECLSPEC LDAC_RESULT ldaclib_check_frame_header(HANDLE_LDAC hData, int smplrate_id, int chconfig_id) {
  LDAC_RESULT result;
...
DECLSPEC LDAC_RESULT ldaclib_init_decode(HANDLE_LDAC hData, int nlnn_shift) {
...
DECLSPEC LDAC_RESULT ldaclib_free_decode(HANDLE_LDAC hData) {
